...
abstract contract ProtectedERC721 is IProtectedERC721, ERC721 {
  ...
  function isApprovedForAll(address, address) public view virtual override(ERC721) returns (bool) {
    return false;
  }
  ...
  function _afterTokenTransfer(address from, address to, uint256 tokenId, uint256 batchSize) internal virtual override(ERC721) {
